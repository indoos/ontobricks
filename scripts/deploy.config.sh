...
DEFAULT_WAREHOUSE_ID="b104fee28afe6079"
DEFAULT_REGISTRY_CATALOG="deprd_gpd"
DEFAULT_REGISTRY_SCHEMA="onto_schema"
DEFAULT_REGISTRY_VOLUME="onto_uc_volume"
DEFAULT_LAKEBASE_INSTANCE_NAME="Databricks-Lakebase"
DEFAULT_LAKEBASE_DATABASE_NAME="onto_db"
DEFAULT_SERVING_ENDPOINT_NAME="databricks-claude-haiku-4-5"
...
DEFAULT_APP_SQL_WAREHOUSE_FALLBACK="b104fee28afe6079"
DEFAULT_APP_DATABRICKS_CATALOG="main"
DEFAULT_APP_DATABRICKS_SCHEMA="default"
DEFAULT_APP_TRIPLESTORE_TABLE="deprd_gpd.onto_schema.default_triplestore"
DEFAULT_APP_REGISTRY_CATALOG="deprd_gpd"
DEFAULT_APP_REGISTRY_SCHEMA="onto_schema"
DEFAULT_APP_REGISTRY_VOLUME="onto_uc_volume"
...
# for the full caveat.
export LAKEBASE_INSTANCE_NAME="${LAKEBASE_INSTANCE_NAME:-$DEFAULT_LAKEBASE_INSTANCE_NAME}"
export LAKEBASE_DATABASE_NAME="${LAKEBASE_DATABASE_NAME:-$DEFAULT_LAKEBASE_DATABASE_NAME}"
export SERVING_ENDPOINT_NAME="${SERVING_ENDPOINT_NAME:-$DEFAULT_SERVING_ENDPOINT_NAME}"
...
export LAKEBASE_BOOTSTRAP_INSTANCE="${LAKEBASE_BOOTSTRAP_INSTANCE:-$LAKEBASE_INSTANCE_NAME}"
